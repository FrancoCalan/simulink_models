...
upload     = False
program    = False
boffile    = 'mbf_16beams_clean.bof.gz'
...
az_ang_range =  [-15, 15, 10]; el_ang_range =  [-15, 15, 10] # [start, stop, step]
#interpolation = 'none'
...
bf_phase_info = {'const_nbits'  : 32,
                 ...
                 'addr_regs'    : ['bf_addr_y', 'bf_addr_x', 'bf_addr_sub'],
                 'we_reg'       : 'bf_phase_we'}

bf_spec_info = {'addr_width'      : 8,
                'word_width'      : 128,
                'data_type'       : '>u8',
                'deinterleave_by' : 2,
                'acc_len_reg'     : 'bf_acc_len',
                'req_reg'         : 'bf_new_acc',
                'read_count_reg'  : 'acc_control_bf_acc_count',
                'bram_names'      : ['bf_probe0_xpow_s0', 'bf_probe0_xpow_s1', 
